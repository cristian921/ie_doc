...
\section{Piattaforma}
Il client su cui è stato eseguito \textbf{JMeeter}(un generatore di workload), è
...
\begin{itemize}
  ...
  \item \textbf{Storage}: SSD Samsung EVO Pro SATA 3
\end{itemize}

Infine sono state utilizzate due tipi di connessione Client-Server, una connessione
diretta tramite cavo di rete LAN ed una in rete locale.\\
